      ...
      -->
        ...
        <div class="sidebar-wrapper">
            <ul class="nav">
                ...
                <li class="nav-item ">
                    <a class="nav-link" href="../dist/itemForm.php">
                        <i class="material-icons">person</i>
                        <p>Manage Items</p>
                    </a>
                </li>
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-header card-header-primary">
                                ...
                                <p class="card-category">Complete Item Form</p>
                            </div>
                            <div class="card-body">
                                <form id="ItemForm">
                                    <div class="row">
                                    ...
                                    <button type="button" class="btn btn-primary pull-right" id="itemsave">Save</button>
                                    <button type="button" class="btn btn-primary pull-right" id="itemdelete">Delete
                                    </button>
                                    <button type="button" class="btn btn-primary pull-right" id="itemupdate">Update
                                    </button>
