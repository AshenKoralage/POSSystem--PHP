      ...
      -->
        ...
        <div class="sidebar-wrapper">
            <ul class="nav">
                ...
                <li class="nav-item ">
                    <a class="nav-link" href="../dist/Customer.php">
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-header card-header-primary">
                                ...
                                <p class="card-category">Complete Customer Form</p>
                            </div>
                            <div class="card-body">
                                <form id="customerForm">
                                    ...
                                    <button type="button" class="btn btn-primary pull-right" id="btnDelete">Delete
                                    </button>
                                    <button type="button" class="btn btn-primary pull-right" id="btnUpdate">Update
                                    </button>
